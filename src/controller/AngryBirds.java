...
public class AngryBirds extends Panel implements Runnable, MouseListener, MouseMotionListener, Observer {
    /**
	 * 
	 */
	private static final long serialVersionUID = 3826540286027041075L;
    ...
    public void paint(Graphics g2) {
        ...
        ImageObserver observerBird = null;
        Image imgBird =  new ImageIcon(this.getClass().getResource("../view/Images/imageBird.png")).getImage();
        g.drawImage(imgBird, (int) birdX - 20, (int) birdY - 20, 40, 40, observerBird);
        //g.fillOval((int) birdX - 20, (int) birdY - 20, 40, 40);

        // cochon
        //g.setColor(Color.GREEN);
        ImageObserver observerPig = null;
        Image imgPig =  new ImageIcon(this.getClass().getResource("../view/Images/imagePig.png")).getImage();
		g.drawImage(imgPig, (int) pigX -20, (int) pigY - 20, 40, 40, observerPig);
